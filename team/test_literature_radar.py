...
class TeamLiteratureRadarTest(unittest.TestCase):
    ...
    def test_team_research_database_records_schema_migration_status(self) -> None:
        ...
        self.assertEqual(status["expected_version"], 6)
        self.assertEqual(status["applied_count"], 6)
        ...
        self.assertEqual(status["applied_migrations"][5]["id"], "006_security_news_ai_cards_tags")
